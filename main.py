...
# --- PATH RESOLUTION (FOR ROOT DEPLOYMENT) ---
...
async def serve_static(path: str):
    # Avoid infinite loops by ignoring API paths in catch-all
    if path.startswith("api/"): return JSONResponse({"error": "API route not found"}, status_code=404)
